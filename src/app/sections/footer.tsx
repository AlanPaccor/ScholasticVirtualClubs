...
export default function Footer({ border = false }: { border?: boolean }) {
  return (
    <footer className="overflow-clip bg-black">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div className="text-lg text-white font-bold">
              Scholastic Virtual School Clubs
            </div>
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-white/50 text-sm font-medium">Product</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  className="text-white transition hover:text-gray-900"
                  href="#0"
                >
                  Features
                </Link>
          ...
          {/* 3rd block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-white/50 text-sm font-medium">Company</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  className="text-white transition hover:text-gray-900"
          ...
          {/* 4th block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-white/50 text-sm font-medium">Resources</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  className="text-white transition hover:text-gray-900"
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="flex gap-1">
              <li>
                <Link
                  className="flex items-center justify-center text-white/50 transition hover:text-white"
                  href="#0"
                  aria-label="Twitter"
                >
                  <svg
